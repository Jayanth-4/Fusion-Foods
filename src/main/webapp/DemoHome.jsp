...
<%@ page import="java.util.List, com.FusionFoods.Model.Restaurant" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="home-page">
    ...
    <div class="home">
        ...
        <div class="restaurant-list">
	        <div class="greet">
	            <div class="greet-welcome"><h2>Please Sign-In and Start Ordering.!!!</h2></div>
	        </div>
            <%
                ...
                if (restaurantList != null) {
                    for (Restaurant res : restaurantList) {
            			%><div class="restaurant">
                				<a class="menulink" href="menu?restaurantId=<%= res.getResturantId() %>">
